 ...
 * value everywhere.
 */
abstract class AbstractIteratedFunctionMapPlot(
    ...
    protected abstract fun f(z: Complex): Complex
    protected open fun op(fz: Complex, c: Complex) = fz + c
    ...
    private fun createPlot() = EscapeTimePlot.complex(title)
        ...
        .domainX(pMin, pMax)
        .domainY(qMin, qMax)
        .colorFn(escapeTime(EscapeTimePalette))
