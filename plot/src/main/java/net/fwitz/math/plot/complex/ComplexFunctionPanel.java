...
import net.fwitz.math.plot.color.filter.ComplexFunctionValueFilters;
...
public class ComplexFunctionPanel extends AbstractComplexFunctionPanel<Complex> {
    ...
    protected ComplexFunctionRenderer<Complex> createRenderer(int width, int height) {
        return new ComplexFunctionRenderer<>(this, valueType, width, height, ComplexFunctionValueFilters.getInstance());
    }
}
